// @use js
import eslintrc from '../../../_src/.eslintrc.js'
// const eslintrc = await import(`../../${define.path.srcDir}.eslintrc.js`);

// @use common
// const meta = await import(`../../${define.path.pageConfig}`);
import meta from '../../../_src/config/page.js'
